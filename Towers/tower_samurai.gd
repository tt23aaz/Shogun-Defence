...
# Preloads the katana scene
var Bullet = preload("res://Towers/katana.tscn")

# The damage of each katana hit will deal
...
@onready var tower_sprite = $SamuraiSprite
...
# Removes all the katanas in the bullet container
func clear_bullets():
...
func Shoot() -> void:
	...
	# Pass target path and damage data to the katana
