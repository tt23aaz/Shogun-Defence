...
# Preloads the shuriken scene
var Bullet = preload("res://Towers/shuriken.tscn")

# The damage of each shuriken hit will deal
...
# Removes all the shurikens in the bullet container
func clear_bullets():
...
func Shoot() -> void:
	...
	# Pass target path and damage data to the shuriken
